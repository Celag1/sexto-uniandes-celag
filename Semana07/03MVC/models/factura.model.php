<?php
// TODO: Clase de Factura Tienda Cel@g - Celso Aguirre
...
class Factura
{
    ...
    //FIXME: MODIFICACION PARA GENERAR EL REPORTE DE FACTURA. REVISAR CONTROLLER.
    public function obtenerDetalleFactura($idFactura) {
        $con = new ClaseConectar();
        $con = $con->ProcedimientoParaConectar();
        $cadena = "SELECT df.Cantidad, df.Precio_Unitario, df.Sub_Total_item, p.Nombre_Producto 
